...
const Dashboard = () => {
  ...
  const [vehicles] = useState<Vehicle[]>([
    ...
    { id: "4", make: "Chevrolet", model: "Silverado", year: 2021, licensePlate: "JKL-012", vin: "VIN6789012345", status: "active", mileage: 30000, assignedDriverId: null },
    { id: "5", make: "Nissan", model: "NV200", year: 2019, licensePlate: "MNO-345", vin: "VIN2345678901", status: "inactive", mileage: 90000, assignedDriverId: null },
    { id: "6", make: "Ram", model: "ProMaster", year: 2020, licensePlate: "PQR-678", vin: "VIN3456789012", status: "maintenance", mileage: 60000, assignedDriverId: "D002" },
  ]);
